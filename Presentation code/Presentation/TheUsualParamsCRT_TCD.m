...
% Monitor: 
% Old monitor H=32.5cm, V=24.25cm
% Checked H=40.5cm, V=30.5cm

% scres = [1366 768]; % for computer of GL, neural eng lab.
scres = [1024 768]; % for EEG lab computer H,V
% cm2px = 39.3846 ;
cm2px = scres(1)/32.5;

dist = 56;  % viewing distance in cm is closer than using LCD (57)

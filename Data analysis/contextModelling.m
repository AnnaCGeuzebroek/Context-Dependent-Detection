...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% all parameters from EEG to use for NI modelling. 
...
%% 1.1) 3Bound1Drift1Leak1tnd, e.g. 3 bounds, 1 drift, 1 leak and 1 tnd
...
Params_3Bound = parModelling.applyModelling(ModelName,  [], modelPar, repeats);
...
Params_3Bound = parModelling.applyModelling(ModelName, Params_3Bound(1:50,:), modelPar); % refine first 50 parameters.
...
%     {'Leak', 'Bound weak', 'Bound strong', 'Bound mixed'},  [modelPar.Lower([5 1:3],:) modelPar.Upper([5 1:3],:)]);
...
[Params_3Bound2Drift, Err] = parModelling.applyModelling(ModelName, Params_3Bound(1:20,[1:3 5:end]),modelPar, repeats,...
...
% 2.1) 3Leak1Drift1Tnd1stdNoise, e.g. 1 leak, 1 drift, 1 leak, 1 tnd and a
% noise parameter.
...
Params_NI3Leak = applyNIModelling(parModelling, ModelName, urg, applyReflectiveBound, [], modelPar, numRepeats);

% refine fitting
parModelling.options.TolFun  = 1e-4;
parModelling.options.MaxIter = 1000; % maximum iterations
parModelling.modelBehaviour.simulateMoreX = 5;
Params_NI3Leak = applyNIModelling(parModelling, ModelName, urg, applyReflectiveBound, Params_NI3Leak(1:25,:), modelPar);
...
% 2.1) NI_3Leak4Drift1Tnd1stdNoise, e.g. 3 leak, 4 drift, 1 leak, 1 tnd and a
% noise parameter.
numRepeats = 200;
...
Params_NI3Leak4drift = applyNIModelling(parModelling, ModelName,urg, applyReflectiveBound,  Params_NI3Leak(:, [1:3 5:end]), modelPar, numRepeats,...
...
parModelling.modelBehaviour.simulateMoreX = 1;
Params_NI3Criteria = applyNIModelling(parModelling, ModelName, urg, applyReflectiveBound, [], modelPar, repeats);

% refine NI 3 criteria model
parModelling.options.TolFun = 1e-4;
parModelling.options.MaxIter = 1000; % maximum iterations
parModelling.modelBehaviour.simulateMoreX = 5;
Params_NI3Criteria = applyNIModelling(parModelling, ModelName, urg, applyReflectiveBound, Params_NI3Criteria(1:25,:), modelPar);
...
Params_NI3Criteria4drift = applyNIModelling(parModelling, ModelName, urg, applyReflectiveBound,  Params_NI3Criteria(:, [1:3 5:end]), modelPar, numRepeats,...

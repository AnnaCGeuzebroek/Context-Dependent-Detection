...
parameters.stim.duration     = 1;    % or parameters.experiment{1}{1}.par.targetDur.*1000;    % in sec., duration of the stimulus
...
parameters.stim.epoch        = [-1.8 2.5];  % in sec., duration of the stimulus 
